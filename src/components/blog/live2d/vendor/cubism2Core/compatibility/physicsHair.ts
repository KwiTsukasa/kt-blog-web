...
interface Cubism2PhysicsHairInstance {
  ...
  setup: (offsetY?: number, airResistance?: number, mass?: number) => void
 ...
 * @param options Math constants and bootstrap state supplied by the min.js-derived compatibility capsule.
...
export function createCubism2PhysicsHair(
   ...
   * @param offsetY Initial Y offset/rest length between the root and child point.
   ...
   * @param sourceKind Source mapping mode from `PhysicsHair.Src`.
  ...
  /**
   * Namespace constructor matching the legacy `PhysicsHair.Src` function object shape.
   */
  function PhysicsHairSourceNamespace(): void {}

  /**
   * Namespace constructor matching the legacy `PhysicsHair.Target` function object shape.
   */
  function PhysicsHairTargetNamespace(): void {}

  Hair.Src = PhysicsHairSourceNamespace as unknown as Cubism2PhysicsHairConstructor['Src']
  Hair.Src.SRC_TO_X = 'SRC_TO_X'
  Hair.Src.SRC_TO_Y = 'SRC_TO_Y'
  Hair.Src.SRC_TO_G_ANGLE = 'SRC_TO_G_ANGLE'
  Hair.Target = PhysicsHairTargetNamespace as unknown as Cubism2PhysicsHairConstructor['Target']
  Hair.Target.TARGET_FROM_ANGLE = 'TARGET_FROM_ANGLE'
  Hair.Target.TARGET_FROM_ANGLE_V = 'TARGET_FROM_ANGLE_V'
