...
export interface Cubism2DrawParamBaseInstance {
  ...
  getClipBufPre_clipContextDraw: () => unknown | null
  getClipBufPre_clipContextMask: () => unknown | null
  ...
  setClipBufPre_clipContextForDraw: (clipContext: unknown | null) => void
  setClipBufPre_clipContextForMask: (clipContext: unknown | null) => void
 ...
 * @param options Runtime dependencies from the min.js-derived compatibility capsule.
...
export function createCubism2DrawParamBase(
  ...
  DrawParamBase.prototype.setBaseColor = function (
    ...
    this.baseAlpha = clampUnitColorComponent(alpha)
    this.baseRed = clampUnitColorComponent(red)
    this.baseGreen = clampUnitColorComponent(green)
    this.baseBlue = clampUnitColorComponent(blue)
  }
   ...
   */
  DrawParamBase.prototype.setClipBufPre_clipContextForMask = function (
    clipContext: unknown | null,
  ): void {
    this.clipBufPre_clipContextMask = clipContext
  }
   ...
   */
  DrawParamBase.prototype.getClipBufPre_clipContextMask = function (): unknown | null {
   ...
   */
  DrawParamBase.prototype.setClipBufPre_clipContextForDraw = function (
    clipContext: unknown | null,
  ): void {
    this.clipBufPre_clipContextDraw = clipContext
  }
   ...
   */
  DrawParamBase.prototype.getClipBufPre_clipContextDraw = function (): unknown | null {
  ...
  function Cubism2RgbaColor(this: Cubism2RgbaColorInstance): void {
    ...
    this.b = 1
    this.scale = 1
    this.blendMode = options.Live2D.L2D_COLOR_BLEND_MODE_MULT
  }
