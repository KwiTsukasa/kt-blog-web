...
export function createCubism2ModelBase(
   ...
   */
  function loadMocDataIntoModelFromMocBinary(
  ...
  ModelBase.loadMocDataIntoModel = loadMocDataIntoModelFromMocBinary
   ...
   */
  function setDeserializedModelImplementation(
    this: Cubism2ModelBaseInstance,
    modelImpl: Cubism2ModelImplLike,
  ): void {
    this.modelImpl = modelImpl
  }
  ModelBase.prototype.setModelImpl = setDeserializedModelImplementation
   ...
   */
  function getOrCreateModelImplementation(this: Cubism2ModelBaseInstance): Cubism2ModelImplLike {
  ...
  ModelBase.prototype.getModelImpl = getOrCreateModelImplementation
   ...
   */
  function getLoadedModelCanvasWidth(this: Cubism2ModelBaseInstance): number {
    if (this.modelImpl == null) {
      return 0
    }
    return this.modelImpl.getCanvasWidth()
  }
  ModelBase.prototype.getCanvasWidth = getLoadedModelCanvasWidth
   ...
   */
  function getLoadedModelCanvasHeight(this: Cubism2ModelBaseInstance): number {
    if (this.modelImpl == null) {
      return 0
    }
    return this.modelImpl.getCanvasHeight()
  }
  ModelBase.prototype.getCanvasHeight = getLoadedModelCanvasHeight
   ...
   */
  function getModelParameterFloat(
    this: Cubism2ModelBaseInstance,
  ...
  ModelBase.prototype.getParamFloat = getModelParameterFloat
   ...
   */
  function setModelParameterFloat(
    this: Cubism2ModelBaseInstance,
    paramIdOrIndex: unknown,
    value: number,
    weight?: number,
  ...
  ModelBase.prototype.setParamFloat = setModelParameterFloat
   ...
   * @returns Nothing; the selected model-context parameter is updated.
   */
  function addToModelParameterFloat(
    this: Cubism2ModelBaseInstance,
    paramIdOrIndex: unknown,
    value: number,
    weight?: number,
  ...
  ModelBase.prototype.addToParamFloat = addToModelParameterFloat
   ...
   * @returns Nothing; the selected model-context parameter is updated.
   */
  function multiplyModelParameterFloat(
    this: Cubism2ModelBaseInstance,
    paramIdOrIndex: unknown,
    value: number,
    weight?: number,
  ...
  ModelBase.prototype.multParamFloat = multiplyModelParameterFloat
   ...
   */
  function getModelParameterIndex(
    this: Cubism2ModelBaseInstance,
    paramId: unknown,
  ): number {
    return this.modelContext.getParamIndex(ParamID.getID(paramId))
  }
  ModelBase.prototype.getParamIndex = getModelParameterIndex
   ...
   */
  function loadSavedModelParametersIntoContext(this: Cubism2ModelBaseInstance): void {
    this.modelContext.loadParam()
  }
  ModelBase.prototype.loadParam = loadSavedModelParametersIntoContext
   ...
   */
  function saveCurrentModelParametersFromContext(this: Cubism2ModelBaseInstance): void {
    this.modelContext.saveParam()
  }
  ModelBase.prototype.saveParam = saveCurrentModelParametersFromContext
   ...
   */
  function initializeModelContextRuntimeState(this: Cubism2ModelBaseInstance): void {
    this.modelContext.init()
  }
  ModelBase.prototype.init = initializeModelContextRuntimeState
   ...
   */
  function updateModelContextRuntimeState(this: Cubism2ModelBaseInstance): void {
    this.modelContext.update()
  }
  ModelBase.prototype.update = updateModelContextRuntimeState
   ...
   */
  function getAbstractRendererTextureCount(this: Cubism2ModelBaseInstance): number {
    void this
    UtDebug.logWithLegacyPrefix('Live2DModelBase.getTextureCount() is abstract')
    return -1
  }
  ModelBase.prototype.getTextureCount = getAbstractRendererTextureCount
   ...
   */
  function setAbstractRendererDrawParam(
    this: Cubism2ModelBaseInstance,
    drawParam: unknown,
  ): void {
    void this
  ...
  ModelBase.prototype.setDrawParam = setAbstractRendererDrawParam
   ...
   */
  function releaseAbstractRendererTextures(this: Cubism2ModelBaseInstance): void {
    void this
  }
  ModelBase.prototype.releaseRendererTextures = releaseAbstractRendererTextures
   ...
   * @returns Nothing in the abstract base implementation.
   */
  function drawAbstractModel(this: Cubism2ModelBaseInstance): void {
    void this
  }
  ModelBase.prototype.draw = drawAbstractModel
   ...
   */
  function getOwnedModelContext(this: Cubism2ModelBaseInstance): Cubism2ModelContextLike {
    return this.modelContext
  }
  ModelBase.prototype.getModelContext = getOwnedModelContext
   ...
   */
  function getModelLoadErrorFlags(this: Cubism2ModelBaseInstance): number {
    return this.loadErrorFlags
  }
  ModelBase.prototype.getLoadErrorFlags = getModelLoadErrorFlags
   ...
   */
  function updateParamDrivenPartsOpacityFromParameters(
    this: Cubism2ModelBaseInstance,
    paramIdsOrIndexes: unknown[],
    partsIdsOrIndexes: unknown[],
    deltaTime: number,
  ...
  ModelBase.prototype.updateParamDrivenPartsOpacity = updateParamDrivenPartsOpacityFromParameters
  ...
  ModelBase.prototype.setPartsOpacity = setModelPartOpacity
   ...
   */
  function getModelPartsDataIndex(this: Cubism2ModelBaseInstance, partsId: unknown): number {
    if (!(partsId instanceof PartsDataID)) {
      partsId = PartsDataID.getID(partsId)
    }
    return this.modelContext.getPartsDataIndex(partsId)
  }
  ModelBase.prototype.getPartsDataIndex = getModelPartsDataIndex
  ...
  ModelBase.prototype.getPartsOpacity = getModelPartOpacity
   ...
   */
  function getAbstractRendererDrawParam(this: Cubism2ModelBaseInstance): unknown {
    void this
    return undefined
  }
  ModelBase.prototype.getDrawParam = getAbstractRendererDrawParam
   ...
   */
  function getModelDrawDataIndex(this: Cubism2ModelBaseInstance, drawDataId: unknown): number {
    return this.modelContext.getDrawDataIndex(DrawDataID.getID(drawDataId))
  }
  ModelBase.prototype.getDrawDataIndex = getModelDrawDataIndex
   ...
   */
  function getModelDrawData(this: Cubism2ModelBaseInstance, drawDataIndex: number): unknown {
    return this.modelContext.getDrawData(drawDataIndex)
  }
  ModelBase.prototype.getDrawData = getModelDrawData
   ...
   */
  function getMeshTransformedPoints(
    this: Cubism2ModelBaseInstance,
  ...
  ModelBase.prototype.getTransformedPoints = getMeshTransformedPoints
   ...
   */
  function getMeshIndexArray(this: Cubism2ModelBaseInstance, drawDataIndex: number): unknown {
  ...
  ModelBase.prototype.getIndexArray = getMeshIndexArray
