...
export interface CreateCubism2BinaryReaderOptions {
  ...
  valueConstructors: {
    ...
    tag22XYValueConstructor: Cubism2ValueConstructor
  }
}
 ...
 * @param options Legacy constructors and static helpers injected by the compatibility capsule.
  ...
  BinaryReader.prototype.readValueForTypeTag = function (typeId: number): unknown {
    ...
    switch (typeId) {
      ...
      case TYPE_TAG_XY_VALUE:
        return new tag22XYValueConstructor(this.readInt32(), this.readInt32())
