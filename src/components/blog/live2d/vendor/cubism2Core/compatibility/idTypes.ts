...
export function createCubism2IdTypes(
   ...
   */
  function getDefaultBaseDataID(): Cubism2IdInstance {
  ...
  BaseDataIdConstructor.getDefaultBaseDataID = getDefaultBaseDataID
   ...
   */
  function resetAllIdCaches(): void {
  ...
  IdBase.resetAllIdCaches = resetAllIdCaches
