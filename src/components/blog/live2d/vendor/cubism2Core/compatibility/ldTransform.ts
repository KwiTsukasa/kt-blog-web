...
export function createCubism2LDTransform(): Cubism2LDTransformConstructor {
   ...
   * @param targetTransform Optional target transform; a new one is created for legacy callers that omit it.
  ...
  /**
   * Appends another transform by matrix multiplication.
